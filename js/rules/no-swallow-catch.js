...
module.exports = {
  meta: {
    type: 'problem',
    docs: { description: 'catch must throw, call a reporter, convert to a Result boundary (return { ok: false, cause: err } when the function returns Result/Attempt), or carry // no-report: marker above the try. Boundary conversion is kin to the policy layer.' },
    messages: {
